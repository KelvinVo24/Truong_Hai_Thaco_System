...
<head>
    <title>Admin - Truong Hai Thaco</title>
    ...
    <link rel="stylesheet" href="/pdo_Signup/Test/style.css">
...
<body>
    ...
    <div class="container-fluid px-1 px-md-5 px-lg-1 px-xl-5 py-5 mx-auto">
        ...
        ?>
        <h3 align="center">Truong Hai Thaco - Admin</h3><br />
        <form method="post">
            ...
            <div class="row d-flex">
                <div class="col-lg-6">
                    <div class="card1 pb-5">
                        <div class="row">
                            <img src="/pdo_Signup/User/uploads/profile.jpg" class="logo">
                        </div>
                        <div class="row px-3 justify-content-center mt-4 mb-5 border-line">
                            <img src="/pdo_Signup/User/uploads/pexels-james-wheeler-417074.jpg" class="image">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="card2 card border-0 px-4 py-5">
                        ...
                        <div class="row px-3">
                            ...
                            <input class="mb-4" type="text" name="UserName" class="form-control" placeholder="Enter a valid email address">
                        </div>
                        <div class="row px-3">
                        ...
                        <div class="row mb-3 px-3">
                            <button type="submit" name="login" class="btn btn-blue text-center">Login</button>
                        </div>
                        <div class="row mb-4 px-3">
