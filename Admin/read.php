...
<div class="content read">
	<h2>Read Products</h2>
	<a href="create.php" class="create-contact"><i class="fa-solid fa-plus" style="color: #ffffff;"></i> Add new</a>
	<table>
        <thead>
            <tr>
                <td>#</td>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><img src="<?= $product['image'] ?>" title="<?= $product['image'] ?>" width='220' height='150'></td>

                <td class="actions">
                    <a href="update.php?pro_id=<?=$product['pro_id']?>" class="edit"><i class="fa-solid fa-pen" style="color: #FFC107;"></i></a>
                    <a href="delete.php?pro_id=<?=$product['pro_id']?>" class="trash"><i class="fa-solid fa-trash" style="color: #ff0000;"></i></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
